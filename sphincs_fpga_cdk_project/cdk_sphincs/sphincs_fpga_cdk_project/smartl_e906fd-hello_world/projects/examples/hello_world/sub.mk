...
INCLUDEDIRS += -I$(ROOTDIR)/csi_kernel/freertosv10.3.1/FreeRTOS/Source/include
INCLUDEDIRS += -I$(ROOTDIR)/csi_kernel/freertosv10.3.1/FreeRTOS/Source/portable/GCC/riscv/chip_specific_extensions/thead_rv32/
INCLUDEDIRS += -I$(ROOTDIR)/csi_kernel/freertosv10.3.1/FreeRTOS/Source/portable/GCC/riscv

CSRC += $(ROOTDIR)/csi_kernel/freertosv10.3.1/FreeRTOS/Source/portable/GCC/riscv/port.c
SSRC += $(ROOTDIR)/csi_kernel/freertosv10.3.1/FreeRTOS/Source/portable/GCC/riscv/portASM.S

CSRC += $(ROOTDIR)/csi_kernel/freertosv10.3.1/adapter/csi_freertos.c
CSRC += $(ROOTDIR)/csi_kernel/freertosv10.3.1/FreeRTOS/Source/croutine.c
CSRC += $(ROOTDIR)/csi_kernel/freertosv10.3.1/FreeRTOS/Source/event_groups.c
CSRC += $(ROOTDIR)/csi_kernel/freertosv10.3.1/FreeRTOS/Source/list.c
CSRC += $(ROOTDIR)/csi_kernel/freertosv10.3.1/FreeRTOS/Source/portable/MemMang/heap_4.c
CSRC += $(ROOTDIR)/csi_kernel/freertosv10.3.1/FreeRTOS/Source/queue.c
CSRC += $(ROOTDIR)/csi_kernel/freertosv10.3.1/FreeRTOS/Source/stream_buffer.c
CSRC += $(ROOTDIR)/csi_kernel/freertosv10.3.1/FreeRTOS/Source/tasks.c
CSRC += $(ROOTDIR)/csi_kernel/freertosv10.3.1/FreeRTOS/Source/timers.c
endif
